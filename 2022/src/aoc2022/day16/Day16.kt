...
private fun allCombinationsOf(inputs: aoc2022.common.BitSet): Set<aoc2022.common.BitSet> {
...
private fun maxFlowPossibleForValveSet(valves: Array<Valve>, timeLimit: Int, targets: aoc2022.common.BitSet, timeToReach: Array<IntArray?>, startAt: Int): Int {
    fun maxFlowFromVisitingDownstreamValves(thisValve: Int, elapsed: Int, flowPerMinute: Int, valvesOpen: aoc2022.common.BitSet): Int {
...
private fun buildDistanceCache(targetValves: aoc2022.common.BitSet, valves: Array<Valve>) =
