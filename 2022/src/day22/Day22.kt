...
private val exampleInput = "day22/example.txt".fromClasspathFile()
private val puzzleInput = "day22/input.txt".fromClasspathFile()
...
fun parseInstructions(chars: CharArray): List<String> {
    var i = 0
