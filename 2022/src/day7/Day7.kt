...
import common.*
import day7.InputParsing.ListingItem.Companion.toFileSet
import kotlin.test.*

private val exampleInput = "day7/example.txt".fromClasspathFileToLines()
private val puzzleInput = "day7/input.txt".fromClasspathFileToLines()
private val part1ExpectedTree = "day7/expectedExampleFileTree.txt".fromClasspathFile()
